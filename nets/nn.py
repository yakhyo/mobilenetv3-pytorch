...
class CrossEntropyLoss:
    ...
    def __init__(self, weight=None, ignore_index=-100, reduction='mean', label_smoothing=0.0) -> None:
        super().__init__()
        self.weight = weight
    ...
    def __call__(self, prediction, target):
        return F.cross_entropy(prediction, target, weight=self.weight, ignore_index=self.ignore_index,
